...
class PaintGUI:
    ...
    def __init__(self):
        ...
        self.root = Tk()
        self.root.title("Its A Copy OF MS Paint Made By D_eFAuLT")
    ...
    def change_color(self):
        ...
        _, self.current_color = colorchooser.askcolor(title="Chose A Color")

    def on_closing(self):
        answer = messagebox.askyesnocancel("Quit", "Do you wana save ur work ??", parent=self.root)
